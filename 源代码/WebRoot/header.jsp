    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Jiaofei/frontlist">缴费记录</a></li>
                <li><a href="<%=basePath %>Coach/frontlist">教练风采</a></li>
                <li><a href="<%=basePath %>Exam/frontlist">考试查询</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Jiaofei/userFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的缴费记录</a></li>
                        <li><a href="<%=basePath %>Exam/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的考试查询</a></li>
