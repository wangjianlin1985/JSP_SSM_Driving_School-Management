...
public class JiaofeiController extends BaseController {
	...
	public String userFrontlist(@ModelAttribute("jiaofeiTypeObj") JiaofeiType jiaofeiTypeObj,String jiaofeiName,@ModelAttribute("userObj") UserInfo userObj,String jiaofeiTime,Integer currentPage, Model model, HttpServletRequest request,HttpSession session) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (jiaofeiName == null) jiaofeiName = "";
		if (jiaofeiTime == null) jiaofeiTime = "";
	    ...
	    List<UserInfo> userInfoList = userInfoService.queryAllUserInfo();
	    request.setAttribute("userInfoList", userInfoList);
		return "Jiaofei/jiaofei_userFrontquery_result"; 
	}
