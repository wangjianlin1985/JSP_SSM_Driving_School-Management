...
public class ExamController extends BaseController {
	...
	public String userFrontlist(String examName,String kemu,@ModelAttribute("userObj") UserInfo userObj,String examDate,String examPlace,@ModelAttribute("coachObj") Coach coachObj,Integer currentPage, Model model, HttpServletRequest request,HttpSession session) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (examName == null) examName = "";
		if (kemu == null) kemu = "";
		if (examDate == null) examDate = "";
	    ...
	    List<UserInfo> userInfoList = userInfoService.queryAllUserInfo();
	    request.setAttribute("userInfoList", userInfoList);
		return "Exam/exam_userFrontquery_result"; 
